{{-- ╔══════════════════════════════════════════════════════╗
     ║  Saveur — Create Recipe  ·  Wizard Multi-Step         ║
     ║  Chaque étape s'affiche en plein écran, sans scroll   ║
     ╚══════════════════════════════════════════════════════╝ --}}
...
/* ── Reset scoped ── */
.sfwiz * { box-sizing: border-box; margin: 0; padding: 0; }

/* ══════════════════════════════════════
   LAYOUT — plein viewport, aucun scroll
══════════════════════════════════════ */
.sfwiz {
...
.sfwiz-step-item.is-active .sfwiz-step-dot {
    background: var(--accent);
    border-color: var(--accent);
    color: #fff;
    box-shadow: 0 0 0 4px rgba(184,74,28,.14);
}

.sfwiz-step-item.is-done .sfwiz-step-dot {
    background: var(--accent);
    border-color: var(--accent);
    color: #fff;
}
...
.sfwiz-step-item.is-active .sfwiz-step-label,
.sfwiz-step-item.is-done  .sfwiz-step-label { color: var(--text); }

.sfwiz-step-line {
    flex: 1; height: 1px; background: var(--sand);
    margin: 0 .45rem; min-width: 12px;
...
/* ── Thin progress bar ── */
.sfwiz-progressbar {
    flex-shrink: 0; height: 2px; background: var(--sand);
}
.sfwiz-pb-fill {
...
.sfwiz-input:focus,
.sfwiz-select:focus,
.sfwiz-textarea:focus {
    border-color: var(--accent);
    box-shadow: 0 0 0 3px rgba(184,74,28,.10);
    background: var(--white);
}
.sfwiz-input::placeholder,
.sfwiz-textarea::placeholder { color: #c5b8a8; font-weight: 300; }
.sfwiz-input.err, .sfwiz-select.err, .sfwiz-textarea.err {
    border-color: var(--danger); background: #fff9f9;
}
...
.sfwiz-unit {
    ...
    font-size: .7rem; font-weight: 500; color: var(--muted); pointer-events: none;
}
...
.sfwiz-tag input:checked + .sfwiz-tag-pill {
...
/* ── Upload ── */
.sfwiz-upload {
    border: 2px dashed var(--sand); border-radius: var(--r-lg);
    padding: 2rem 1.5rem;
...
.sfwiz-upload:hover .sfwiz-upload-icon { border-color: var(--accent); background: var(--accent-pale); transform: translateY(-2px); }
...
.sfwiz-prev-rm { display: none; margin-top: .35rem; font-size: .72rem; color: var(--muted); background: none; border: none; cursor: pointer; font-family: var(--font-b); transition: color var(--ease); }
.sfwiz-prev-rm:hover { color: var(--danger); }

/* ── Publish toggle ── */
.sfwiz-publish {
    display: flex; align-items: center; justify-content: space-between; gap: 1rem;
    background: var(--white); border: 1px solid var(--sand); border-radius: var(--r-xl);
    padding: 1.1rem 1.4rem; box-shadow: var(--shadow-sm);
}
.sfwiz-publish-info strong {
    display: flex; align-items: center; gap: .4rem;
    font-size: .87rem; font-weight: 500; color: var(--text-dark); margin-bottom: .15rem;
}
...
.sfwiz-recap {
    ...
    background: var(--white); border: 1px solid var(--sand); border-radius: var(--r-xl);
    padding: 1.1rem 1.4rem; box-shadow: var(--shadow-sm); margin-bottom: .85rem;
}
.sfwiz-recap-thumb {
    width: 68px; height: 68px; border-radius: 12px;
    background: var(--cream); border: 1px solid var(--sand); flex-shrink: 0;
...
.sfwiz-btn-back {
    ...
    font-family: var(--font-b); font-size: .84rem; font-weight: 400;
...
.sfwiz-btn-submit {
    ...
    box-shadow: 0 2px 10px rgba(184,74,28,.28);
}
.sfwiz-btn-next:hover,
.sfwiz-btn-submit:hover { background: var(--accent-dark); transform: translateY(-1px); box-shadow: 0 4px 16px rgba(184,74,28,.35); }
.sfwiz-btn-next:active,
.sfwiz-btn-submit:active { transform: translateY(0); }

.sfwiz-btn-draft {
    background: none; border: none;
    font-family: var(--font-b); font-size: .78rem; color: var(--muted);
...
<div class="sfwiz" id="sfWizard">
    ...
    <header class="sfwiz-header">
        ...
        <nav class="sfwiz-steps-nav" id="sfStepsNav">
            {{-- Step 1 --}}
            <div class="sfwiz-step-item is-active" data-step="1">
                ...
                <span class="sfwiz-step-label">Infos</span>
            </div>
            <div class="sfwiz-step-line" data-line="1"></div>

            {{-- Step 2 --}}
            <div class="sfwiz-step-item" data-step="2">
                <div class="sfwiz-step-dot">
                    <span class="num">2</span>
                    <svg class="check" xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                </div>
                <span class="sfwiz-step-label">Tags</span>
            </div>
            <div class="sfwiz-step-line" data-line="2"></div>

            {{-- Step 3 --}}
            <div class="sfwiz-step-item" data-step="3">
                <div class="sfwiz-step-dot">
                    <span class="num">3</span>
                    <svg class="check" xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                </div>
                <span class="sfwiz-step-label">Recette</span>
            </div>
            <div class="sfwiz-step-line" data-line="3"></div>

            {{-- Step 4 --}}
            <div class="sfwiz-step-item" data-step="4">
                <div class="sfwiz-step-dot">
                    <span class="num">4</span>
                    <svg class="check" xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                </div>
                <span class="sfwiz-step-label">Photo</span>
            </div>
            <div class="sfwiz-step-line" data-line="4"></div>

            {{-- Step 5 --}}
            <div class="sfwiz-step-item" data-step="5">
                <div class="sfwiz-step-dot">
                    <span class="num">5</span>
                    <svg class="check" xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                </div>
                <span class="sfwiz-step-label">Publication</span>
            </div>
        </nav>

        <a href="{{ route('home') }}" class="sfwiz-cancel">
    ...
    {{-- ── FORM ── --}}
    <form action="{{ route('recipes.store') }}" method="POST" enctype="multipart/form-data" novalidate id="sfForm">
        @csrf
                        ...
                        <div class="sfwiz-card">
                            <div class="sfwiz-card-body">
                                ...
                                <div class="sfwiz-field">
                                    <label class="sfwiz-label" for="title">
                                        Titre <span class="sfwiz-req">*</span>
                                    </label>
                                    <input type="text" id="title" name="title"
                                           value="{{ old('title') }}"
                                           placeholder="ex. Soupe à l'oignon gratinée"
                                           maxlength="120" data-required
                                           class="sfwiz-input {{ $errors->has('title') ? 'err' : '' }}"
                                           oninput="sfCtr('title',120)">
                                    <div style="display:flex;justify-content:space-between;align-items:center">
                                        @error('title')
                                            <span class="sfwiz-error">{{ $message }}</span>
                                        @else
                                            <span></span>
                                        @enderror
                                ...
                                <div class="sfwiz-field">
                                    ...
                                    <select name="category_id" data-required
                                            class="sfwiz-select {{ $errors->has('category_id') ? 'err' : '' }}">
                                ...
                                {{-- Description --}}
                                <div class="sfwiz-field">
                                    <label class="sfwiz-label">
                                        Description <span class="sfwiz-label-hint">— facultatif</span>
                                    </label>
                        ...
                        <div class="sfwiz-card">
                            <div class="sfwiz-card-body">
                                ...
                                <div style="text-align:right">
                                    <button type="button" class="sfwiz-prev-rm" id="sfRmBtn" onclick="sfRmImg()">
                    ...
                    <div class="sfwiz-slide-inner">
                        ...
                        <div class="sfwiz-publish">
                            <div class="sfwiz-publish-info">
                                <strong>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#3d7c47" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                                    Publier maintenant
                                </strong>
        ...
        <footer class="sfwiz-footer">
            <div class="sfwiz-footer-left">
                <button type="button" class="sfwiz-btn-back" id="sfBack" onclick="sfGo(-1)" style="display:none">
            ...
            <div class="sfwiz-footer-right">
                <button type="button" class="sfwiz-btn-draft" id="sfDraft">Brouillon</button>
                ...
                <button type="submit" class="sfwiz-btn-submit" id="sfSubmit" style="display:none">
...
(function(){
    ...
    function sfRecap() {
        ...
        document.getElementById('sfRecapCat').textContent   = cat || '—';
